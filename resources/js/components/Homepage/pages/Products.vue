						...
						<div class="search-item-container">
							...
							<div class="item-row">
								...
								<div class="item item-thumbnail">
									<router-link to="product-details" class="item-image">
										<img src="assets/img/product/product-iphone.png" alt="" />
										<div class="discount">15% OFF</div>
									</router-link>
									<div class="item-info">
										<h4 class="item-title">
											<router-link to="product-details">iPhone 6s Plus<br />16GB</router-link>
										</h4>
							...
							<div class="item-row">
								...
								<div class="item item-thumbnail">
									...
									<div class="item-info">
										<h4 class="item-title">
											<router-link to="product-details">Apple Watch<br />‏Sport Edition</router-link>
										</h4>
							...
							<div class="item-row">
								...
								<div class="item item-thumbnail">
									...
									<div class="item-info">
										<h4 class="item-title">
											<router-link to="product-details">9.7-inch iPad Pro<br />32GB</router-link>
										</h4>
										<p class="item-desc">3D Touch. 12MP photos. 4K video.</p>
										<div class="item-price">$649.00</div>
										<div class="item-discount-price">$739.00</div>
